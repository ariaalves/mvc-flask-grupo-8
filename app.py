...
app.add_url_rule("/users", view_func=UserController.list_users, endpoint="list_users")
app.add_url_rule("/create_user", view_func=UserController.create_user, methods=['GET', 'POST'], endpoint="create_user")
